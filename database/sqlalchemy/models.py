...
class ComputeNode(BASE, NovaBase, models.SoftDeleteMixin):
    ...
    sgx_enabled = Column(Boolean())
    sgx_memory_mb = Column(Integer)
    sgx_memory_mb_used = Column(Integer)
    sgx_migration_support = Column(Boolean())
...
class Instance(BASE, NovaBase, models.SoftDeleteMixin):
    ...
    sgx_enabled = Column(Boolean(), default=False)
    sgx_memory_mb = Column(Integer,default=0)
    sgx_extra_params = Column(String(255), nullable=True)
    sgx_migration_support = Column(Boolean(), default=False)
