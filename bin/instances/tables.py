...
class InstancesTable(tables.DataTable):
    ...
    #sgx data centre ##START
    
    
    sgx_enabled = tables.Column("sgx_enabled",
                                verbose_name=_("SGX Support"))
    sgx_memory_mb = tables.Column("sgx_memory_mb",
                                verbose_name=_("SGX Memory"))
    sgx_extra_params = tables.Column("sgx_extra_params",
                                verbose_name=_("SGX Extra Parameters"))
    sgx_migration_support = tables.Column("sgx_migration_support",
                                verbose_name=_("SGX Migration Support"))
