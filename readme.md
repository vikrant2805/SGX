...
### SGX Aware client without SGX Hardware Talking with Enclave E


ias_enable  | server_verify_ias | client_verify_ias | Expected output |
----------- | ----------------- | ----------------- |---------------- |
True        | True              | True              | Client verify quote |
True        | True              | False             | Server(E) verify quote |
True        | False             | True              | Client verify quote |
True        | False             | False             | Server(E) verify quote |
False       | True              | True              | Client verify quote |
False       | True              | False             | Server(E) not configure to do ias verification |
False       | False             | True              | Client verify quote |
False       | False             | False             | No IAS verification fake report generated by server(E) |
